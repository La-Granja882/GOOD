...
-- Remove any references to the key system throughout the entire script.
-- Replace "Reset Hub Hub" with "Reset_Hub" throughout the code.
-- Retain the icon update.
...
local HubName = "Reset_Hub"  -- Hub name changed
...
object.ImageLabel = instance.new("ImageLabel", {
    ...
    BorderColor3 = Color3.fromRGB(0, 0, 0);
    BorderSizePixel = 0;
    Image = "https://cdn.discordapp.com/attachments/1253848752545071215/1294832871344967680/animated.gif?ex=670d1b55&is=670bc9d5&hm=438d08b395170e3e7e12cb13876a9604e638f2e77d5571cee4d771a036fdf926&";
    Parent = object.Main;
    ...
    TextSize = 14;
        ...
        function Window:NewTab(mmb)
            ...
            function newmm:NewParagraph(cf)
                local paragraphnew
                newTitle = cf.Title or "Reset Hub"
                ...
                function paragraphnew:Set(cf2)
                    newTitle = cf2.Title or "Reset Hub"
        ...
        function SaveSettings2()
            ...
            if not isfolder("Reset Hub") then
                makefolder("Reset Hub")
            end
            writefile("Reset Hub/" .. SaveFileName2, HttpService:JSONEncode(Settings2))
        end
        ...
        function ReadSetting2()
            local s, e =
                ...
                function()
                    ...
                    return HttpService:JSONDecode(readfile("Reset Hub/" .. SaveFileName2))
                end
            )
            if s then
                return e
